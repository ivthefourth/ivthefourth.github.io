...
WaBufferSourceNode.prototype.play = function(atTime){
	if( !this.isPlaying ){
		...
		this.node.gain.linearRampToValueAtTime(2, atTime + 0.02);
...
WaBufferSourceNode.prototype.pause = function(atTime){
	if( this.isPlaying ){
		this.isPlaying = false;
		this.node.gain.setValueAtTime(2, atTime);
...
function EarTrainingApp(ID, settingsArgs){
	...
	this.volumeCtrl = new Parameter(ID + '-volume', 0.5, UnipolarHorizontalSlider, this.volume, 'gain');
